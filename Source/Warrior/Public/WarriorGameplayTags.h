...
namespace WarriorGameplayTags
{
	...
	WARRIOR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_MuseBeHeld);
	WARRIOR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_MuseBeHeld_Block);
	...
	WARRIOR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Cooldawn_SpecialWeaponAbility_Light);
	WARRIOR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Cooldawn_SpecialWeaponAbility_Heavy);
