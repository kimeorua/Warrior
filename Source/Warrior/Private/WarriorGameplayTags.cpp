...
namespace WarriorGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(InputTag_MuseBeHeld, "InputTag.MuseBeHeld");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_MuseBeHeld_Block, "InputTag.MuseBeHeld.Block");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldawn_SpecialWeaponAbility_Light, "Player.Cooldawn.SpecialWeaponAbility.Light");
	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldawn_SpecialWeaponAbility_Heavy, "Player.Cooldawn.SpecialWeaponAbility.Heavy");
